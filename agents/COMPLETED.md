...
---
- [2026-02-20] T-0237/T-0238/T-0240/T-0241/T-0242: Code health sprint round 2 — consolidated AudioManager crossfade duplication into _do_crossfade(); broke enemy_turn_state.enter() 130-line god method into 4 focused handlers + extracted ENEMY_TURN_DELAY const; extracted equipment_manager SLOT_KEYS const; split quest_manager.deserialize() into 3 focused helpers; extracted pause_menu _hide_for_subscene()/_restore_from_subscene() helpers. 666 tests passing. (claude)
...
- [2026-02-20] T-0179: Add interaction prompt near player — InteractionHint static helper (compute_interaction_hint_text) reads InputMap for bound key; player._update_interaction_prompt() shows/hides prompt each physics frame; fallback '[ ] Interact'; 5 tests (1500 total) (claude)
- [2026-02-20] T-0023: Implement camp/rest system — CampMenuData static helper, CampMenu script-only Control (Rest+Leave Camp, push/pop MENU state), CampStrategy Resource opens from any campfire Interactable via UILayer; 10 tests (1510 total) (claude)
T-0178 | Add read-only control bindings display to settings menu | compute_control_bindings()/compute_action_label()/compute_action_key_label() in SettingsData; GridContainer Controls section in settings_menu.gd; 8 tests (1518 total). PR #240.
T-0026 | Build debug console | DebugCommands static class with compute_debug_command_result() pure parser; CanvasLayer UI with LineEdit (backtick toggle, layer=100); 5 commands (heal_all/set_level/add_item/teleport/set_flag); OS.is_debug_build() guard; 18 tests (1536 total). PR #241.
T-0180 | Place campfire interactable in Verdant Forest | 2026-02-20 | Placed CampStrategy-powered Interactable at Vector2(320,208) in Verdant Forest clearing; one_time=false; 6 tests; PR #242
T-0181 | M0 hygiene sweep — typed refs, remove has_method duck-typing | 2026-02-20 | Added class_name BattleScene; typed BattleManager._battle_scene; removed 4 has_method guards in SaveManager; PR #243
T-0182 | EchoManager autoload with HUD badge and SaveManager integration | 2026-02-20 | New EchoManager autoload (collect/has/count/serialize/deserialize/signal); registered in project.godot; SaveManager gains optional echo_mgr param; MemorialEchoStrategy wired to collect echo after quest objective; HUD echo badge (bottom-right label, static helper); 16 tests; PR #244
T-0189 | Wire EchoManager into all SaveManager save/load call sites | 2026-02-20 | Passed echo_mgr to save_game() in save_point_strategy, apply_save_data() in defeat_state and title_screen; 3 new round-trip tests; 1558 total. PR #246
T-0187 | Echo Collection Journal UI | 2026-02-20 | Script-only EchoJournal Control; Echoes button in pause menu; rarity badge, type tag, lore text, Kael's Notes detail panel; compute_echo_list/compute_echo_detail/compute_echo_count_label static helpers; 10 tests; 1571 total. PR #248
T-0190 | Overgrown Capital dungeon skeleton | 2026-02-20 | Chapter 5 dungeon skeleton: 40x28 tilemap, GroundDebris dynamic layer, Memory Bloom + Creeping Vine encounter pool, SpawnFromRuins marker, camera limits (640x448), boundary walls, Castle.ogg BGM placeholder; 15 tests (1586 total); PR #253
- [2026-02-20] T-0195: Implement Purification Node mechanic for crystal-blocked dungeon paths — PurificationNodeStrategy with node_cleared signal + EventFlags persistence; 2 nodes wired in Overgrown Capital (market_north, entertainment_research); runtime StaticBody2D crystal walls (collision_layer=2); push_warning for odd activation_lines; 10 tests (1648 total); PR #258 (claude)
- [2026-02-20] T-0191: Add Lyra Fragment 2 collectible and Research Quarter vision sequence — lyra_fragment_2.tres (RARE/UNIQUE_ECHO); MemorialEchoStrategy at (448,96) with 10-pair vision (nameplate + 140-day countdown + apology); lyra_fragment_2_collected EventFlag; EchoManager persistence bridge; 8 tests (1656 total); PR #259 (claude)
- [2026-02-20] T-0221: Seed AbilityData .tres for Kael's full ability set — adaptive_strike (30 EE/ATTACK), echo_fusion (40 EE+50%Res/MAGIC), reality_anchor (35 EE/ALL_ALLIES/LIGHT), convergence_touch (60 EE+75%Res/MAGIC/overload); 7 tests (1663 total); PR #260 (claude)
- [2026-02-20] T-0219: Build skill tree UI screen — SkillTreeUI script-only Control with compute_skill_tree_entries/compute_node_state/compute_sp_label static helpers; character list + node list with path headers + detail panel + Unlock button; Skills button added to pause menu; 13 tests (1676 total); PR #261 (claude)
- [2026-02-20] T-0205: Mother's Comfort + First Day of School echo interactables in Overgrown Capital Residential Quarter; first_day_of_school.tres EchoData; compute_residential_echo_positions() + compute_*_vision_lines(); _setup_residential_echoes() wired in _ready(); 14 tests (1745 total); PR #268 (claude)
- [2026-02-20] T-0211: Tilemap visual design for Overgrown Capital — GROUND_MAP (3 terrain types), DETAIL_MAP (64 ornate market tiles), DEBRIS_MAP (35 tiles), WALL_MAP (boundary walls), OBJECTS_MAP (props), ABOVE_PLAYER_MAP (vine canopy overhangs); AbovePlayer @onready wired in overgrown_capital.gd; 9 new tests (14 total in test_overgrown_capital_map.gd); PR merged (claude)
- [2026-02-20] T-0224: Place save point interactables in Overgrown Capital — Market District (col 10, row 23) + Research Quarter (col 28, row 7); compute_research_save_point_position() static helper; _setup_save_points() wired in _ready(); 6 new tests (11 total in test_overgrown_capital_entry.gd); PR #270 (claude)
- [2026-02-20] T-0222: Seed AbilityData .tres files for Iris and Garrick — overclock, shrapnel_shot, prototype_deploy, resonance_disruptor, railgun (Iris); shield_bash, martyrs_resolve, crystal_purge, unbreakable, last_stand (Garrick); 10 new tests in test_iris_garrick_abilities.gd (1770 total); PR #271 (claude)
- [2026-02-20] T-0225: Add Nyx introduction cutscene (Chapter 6 "Born from Nothing") — NyxIntroduction event class, 24-line dialogue compressing Scenes 1-3, gate flags garrick_recruited + lyra_fragment_2_collected, sets nyx_introduction_seen + nyx_met; 14 tests in test_nyx_introduction.gd (1785 total); PR #272 (claude)
- [2026-02-20] T-BGM-01: Fix AudioManager BGM pause — PROCESS_MODE_ALWAYS on AudioManager node + both BGM players so music continues during pause menu (get_tree().paused=true); defeat BGM (Game Over (For Now).ogg) on defeat_state.enter(); level-up jingle (Level Up.ogg) in victory_state when level_ups non-empty; echo collection sting (Echo Captured — Memory Preserved.ogg) in MemorialEchoStrategy via push/pop with 4s timer; Garrick/Iris/Nyx character themes wired to recruitment/introduction cutscenes via push/pop pattern; 49 MP3 tracks converted to OGG (ffmpeg libvorbis q6); music/CLAUDE.md expanded to full OST library index; 12 new/updated tests (1800 total); PR #273 (claude)
