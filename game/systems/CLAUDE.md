...
| `BattleShake` | `battle_shake.gd` | Static utility: screen-shake on heavy damage. `is_heavy_hit(damage, max_hp)`, `compute_intensity(damage, max_hp)`, `shake(node, intensity, duration)`. |
