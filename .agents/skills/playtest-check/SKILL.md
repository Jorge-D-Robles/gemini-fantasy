...
```
Task(subagent_type="playtest-checker", prompt="Run a full pre-playtest validation check on the game/ directory. Check file structure, script compilation, scene references, autoloads, signals, JRPG-specific issues, and performance anti-patterns.")
```
