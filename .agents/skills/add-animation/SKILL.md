...
**Note:** SpriteFrames resources must be configured in the Godot editor — Codex cannot assign individual sprite frames from sprite sheets programmatically. Report this to the user.
