...
1. **Call the `godot-docs` subagent** for the classes involved in the bug:
   ```
   Task(subagent_type="godot-docs", prompt="Look up [CLASS]. I need to verify the correct API for [method/property/signal] to fix a [ERROR_TYPE] issue.")
   ```
