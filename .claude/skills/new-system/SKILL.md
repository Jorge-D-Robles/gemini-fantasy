---
name: new-system
description: Scaffold a new game system (combat, inventory, dialogue, save/load, audio, camera, quest, etc.) with manager script, resources, and autoload setup.
...
| `save` / `save-load` | `save_manager.gd` | — | Yes | io/saving_games, data_paths |
