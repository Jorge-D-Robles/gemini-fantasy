...
description: Plan and implement a complete game feature end-to-end. Looks up docs, creates scenesscriptsresources, and wires everything together. Use for substantial features like combat, dialogue, inventory, or movement systems.
